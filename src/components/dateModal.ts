const dateModal = () => {
    ...
    <dialog id="date-modal" class="rounded-3 border border-2 border-secondary">
            <div class="modal-header p-3 border-1 border-bottom d-flex justify-content-between align-items-center">
                <h1 class="fs-6 fw-bold m-0 p-0">Pick A Date</h1><i class="bi bi-x-lg fw-bold" type="button" id="date-cancel" title="Close Modal"></i>
            </div>
            ...
            <div class="modal-footer p-3">                
                <i class="bi bi-arrow-right-circle-fill fs-1" type="button" id="date-confirm" title="Save Date"></i>
            </div>
